...
export default function Quiz({ questions, saveAttempt, exam, paused, onTogglePause, onRestart, onExit }) {
  ...
  const hasRealExplanation = explanationText.length > 0 && !/pendente de revisão editorial/i.test(explanationText)
