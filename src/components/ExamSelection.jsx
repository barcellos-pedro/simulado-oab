  ...
  return (
    <section className="exam-selection">
      <div className="page-heading">
        ...
        <p>
          Cada sessão tem no máximo 80 questões e usa o gabarito do exame
          selecionado.
        </p>
      </div>
      {exams.length ? (
        <div className="exam-grid">
          {exams.map(({ exam, total }) => (
            <button
              className="exam-card"
              key={exam}
            ...
            >
              ...
              <span className="exam-card-copy">
                <strong>Exame Unificado</strong>
                <small>{Math.min(total, 80)} questões · 5 horas</small>
              </span>
        ...
        <div className="empty-state">
          <span>✦</span>
          <h2>Exames ainda não disponíveis</h2>
          <p>Prepare o conteúdo dos PDFs para liberar os simulados.</p>
        </div>
      )}
    </section>
  );
